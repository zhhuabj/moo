...
class Config(object):
    ...
    def __init__(self):
        ...
        self.xenial_image = 'auto-sync/ubuntu-xenial-16.04-amd64-server-20181223-disk1.img'
    ...
    def _get_openstack_config(self):
        try:
            ...
            self.credentials['project_domain_name'] = environ['OS_PROJECT_DOMAIN_NAME']
            self.credentials['user_domain_name'] = environ['OS_USER_DOMAIN_NAME']
            ...
            self.keystonecredentials['project_name'] = environ['OS_PROJECT_NAME']
            self.keystonecredentials['project_domain_name'] = environ['OS_PROJECT_DOMAIN_NAME']
            self.keystonecredentials['user_domain_name'] = environ['OS_USER_DOMAIN_NAME']
